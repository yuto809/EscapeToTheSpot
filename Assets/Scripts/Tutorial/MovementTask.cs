...
public class MovementTask : ITutorialTask
{
    ...
    public bool CheckTask()
    {
        ...
        //// 事前に決められた距離分移動したら移動チュートリアルは終了と判断する
        //// textMessage.Countは現状は4固定(メッセージ数)
        ...
        //// 中＾とリアル完了後にindexが更新されないからメッセージが読み込まれない

        //// 移動チュートリアルをしている場合は処理しない
        //if (Input.GetMouseButtonDown(0) && textIndex != 2)// (Input.touchCount == 1) tap操作
        //{
        //    textIndex++;
        //    //Debug.Log(textIndex);
        //}
